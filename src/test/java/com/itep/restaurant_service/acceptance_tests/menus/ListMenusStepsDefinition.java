...
//
//public class ListMenusStepsDefinition {
...
//    @Autowired
//    public ListMenusStepsDefinition(RestTemplateBuilder builder, RestaurantRepository restaurantRepository, CategoryRepository categoryRepository, MenuRepository menuRepository) {
...
//
//
//    @When("I query a list of menus of category with ID {long} restaurant with ID {long}")
//    public void getMenus(long categoryId, long restaurantId) {
//        String uri = "http://localhost:8080/restaurants/"+restaurantId+"/category/"+categoryId+ "/com.itep.restaurant_service.acceptance_tests/menus";
//        try{
...
//
//
//    @Then("List all the {int} available menus is returned")
//    public void getAvailableMenus_CheckResponse(int size) {
//        Object body = result.getBody();
//        assertThat(body).isNotNull();
//        assertThat(((Map<String, Map>) body).get("data").get("com.itep.restaurant_service.acceptance_tests/items"))
//                .isInstanceOf(List.class);
//        if (!((List<?>)((Map<String, Map>) body).get("data").get("com.itep.restaurant_service.acceptance_tests/items")).isEmpty()) {
//            assertThat(((Map<String, Map>) body).get("data").get("com.itep.restaurant_service.acceptance_tests/items"))
//                    .asList()
//                    .hasSize(size)
//                    .element(0)
...
//    public void categoryNotFound_CheckResponse() {
