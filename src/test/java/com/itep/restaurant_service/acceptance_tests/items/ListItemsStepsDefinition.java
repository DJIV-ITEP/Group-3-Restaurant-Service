...
//
//public class ListItemsStepsDefinition {
...
//    @Autowired
//    public ListItemsStepsDefinition(RestTemplateBuilder builder, RestaurantRepository restaurantRepository, CategoryRepository categoryRepository, MenuRepository menuRepository, MenuItemRepository itemRepository) {
...
//
//
//    @When("I query a list of items of menu with ID {long} on category with ID {long} restaurant with ID {long}")
//    public void getMenus(long menuId, long categoryId, long restaurantId) {
...
//
//
//    @Then("List all the {int} available items is returned")
